...
export interface User {
  ...
  petCareStyle?: string
  willingToAdopt?: string
  preferredPetSize?: string
  trainingStyle?: string
  breedPreferences?: string
  activityLevelPreference?: string
  energyLevelPreference?: string
  groomingNeedsPreference?: string
  exerciseNeedsPreference?: string
  agePreference?: string
  healthStatusPreference?: string
  specialNeedsAcceptance?: string
  temperamentPreference?: string
  livingSpacePreference?: string
  playStylePreference?: string
  feedingSchedulePreference?: string
  socializationPreference?: string
}
