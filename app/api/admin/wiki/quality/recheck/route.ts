...
/**
 * POST /api/admin/wiki/quality/recheck
 * Re-checks a broken link and marks Source.brokenAt null on success
 */
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      // On success, mark brokenAt as null
      ...
      await prisma.source.update({
        ...
        data: {
          isValid,
          brokenAt, // null on success, Date on failure
