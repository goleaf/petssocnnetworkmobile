...
export default async function WikiArticlePage({ params }: PageProps) {
  ...
  const isLatest = true
  // Use healthData.lastReviewedDate if available (for health articles), otherwise fall back to updatedAt
  const lastReviewedDate = article.healthData?.lastReviewedDate || article.updatedAt
  const expertReviewerId = article.healthData?.expertReviewer
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-8">
          ...
          <div>
            ...
            <ToastBanner
              ...
              expertReviewerId={expertReviewerId}
            />
