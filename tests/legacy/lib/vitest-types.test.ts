...
// Wrap all matcher calls so they are type-checked but not executed under Jest
...
// Provide a minimal passing test to satisfy Jest while keeping type assertions present
test('jest: matchers type assertions are present', () => {
