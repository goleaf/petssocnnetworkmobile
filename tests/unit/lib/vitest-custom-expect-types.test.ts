...
// Define a placeholder-typed expect function to validate matcher types without runtime execution
...
function compileOnlyTypeAssertions() {
...
test('jest: custom matchers type assertions are present', () => {
