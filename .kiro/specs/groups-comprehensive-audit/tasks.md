...
- [ ] 1.1 Add core group tables to prisma/schema.prisma
...
- [ ] 1.2 Add content tables to prisma/schema.prisma
...
- [ ] 1.3 Add event tables to prisma/schema.prisma
...
- [ ] 1.4 Add poll tables to prisma/schema.prisma
  - Create `GroupPoll` model with options, settings
  - Create `PollVote` model for tracking user votes
  - _Requirements: 5.2_

- [ ] 1.5 Add moderation tables to prisma/schema.prisma
...
- [ ] 1.6 Add gamification tables to prisma/schema.prisma
...
- [ ] 1.7 Add wiki tables to prisma/schema.prisma
  - Create `GroupWikiPage` model with hierarchical structure
  - Create `WikiPageRevision` model for version history
  - _Requirements: 13.1-13.5_

- [ ] 1.8 Add analytics and subscription tables to prisma/schema.prisma
...
- [ ] 1.9 Add all database indexes to schema
...
- [ ] 1.10 Generate Prisma client and create migration
...
- [ ] 2.1 Implement core group CRUD operations
...
- [ ] 2.2 Implement group discovery and search
...
- [ ] 2.3 Implement membership management
...
- [ ] 2.4 Implement content operations
...
- [ ] 2.5 Implement event operations
...
- [ ] 2.8 Implement analytics operations
...
- [ ] 3.1 Migrate group management endpoints to use Prisma repository
...
- [ ] 3.2 Migrate and enhance membership endpoints
...
- [ ] 3.4 Migrate and enhance event endpoints
...
- [ ] 3.6 Create moderation endpoints
...
- [ ] 3.8 Create challenge and achievement endpoints
...
- [ ] 4.1 Create group management actions
...
- [ ] 6.1 Create daily analytics computation job
...
- [ ] 6.3 Create event reminders job
...
- [ ] 6.4 Create inactive member cleanup job
...
- [ ] 6.7 Create content moderation scan job
...
- [ ] 8.1 Update GroupForm component (components/groups/GroupForm.tsx)
...
- [ ] 8.9 Update EventCreator component (components/groups/EventCreator.tsx)
...
- [ ] 8.10 Update EventCard component (components/groups/EventCard.tsx)
...
- [ ] 8.11 Update ModerationPanel component (components/groups/ModerationPanel.tsx)
...
- [ ] 8.12 Update AnalyticsDashboard component (components/groups/AnalyticsDashboard.tsx)
...
- [ ] 8.13 Create ChallengeCard component
...
- [ ] 8.14 Create AchievementBadge component
  - Badge icon and display
  - Unlock criteria tooltip
  - Rarity indicator
  - _Requirements: 12.1-12.4_

- [ ] 8.15 Create WikiEditor component
...
- [ ]* 9.1 Write unit tests for repository
...
- [ ]* 9.2 Write unit tests for business logic
...
- [ ] 11.4 Data migration from localStorage
