...
- [x] 2. Implement TypeScript types and interfaces ✅ COMPLETED
...
- [x] 3. Create email change functionality
- [x] 3.1 Implement requestEmailChangeAction server action
...
- [x] 3.2 Implement email verification endpoint
...
- [x] 3.3 Implement email change cancellation endpoint
...
- [x] 3.4 Create email change dialog component
...
- [x] 4. Create password change functionality
- [x] 4.1 Implement updatePasswordAction server action
...
- [x] 4.2 Create password change UI section
...
- [x] 5. Implement session management ✅ COMPLETED
- [x] 5.1 Create session tracking on login
...
- [x] 5.2 Implement getActiveSessionsAction server action
...
- [x] 5.3 Implement session logout actions
...
- [x] 5.4 Implement renameSessionDeviceAction ✅ COMPLETED
...
- [x] 5.5 Create session management UI
...
- [ ]* 6.4 Create scheduled deletion job
...
- [ ] 7.1 Create privacy service module
...
- [ ] 7.2 Create profile visibility UI section
...
- [ ] 7.3 Create granular privacy settings UI
...
- [ ] 7.4 Create tagging and mentions privacy UI
...
- [ ] 7.5 Create messaging privacy UI
...
- [ ] 7.6 Create search and indexing UI
...
- [ ] 8. Implement blocking and muting
- [ ] 8.1 Create blocking service functions
...
- [ ] 8.2 Create blocked users list UI
...
- [ ] 8.3 Create muted users list UI
...
- [ ] 8.4 Implement bulk block functionality
...
- [ ] 9. Implement notification settings
- [ ] 9.1 Create notification service module
...
- [ ] 9.2 Create notification categories UI
...
- [ ] 9.3 Create channel selection UI
...
- [ ] 9.4 Create email digest settings UI
...
- [ ] 9.6 Create notification preview settings UI
...
- [ ] 10. Implement privacy enforcement
- [ ] 10.1 Add privacy checks to profile viewing
...
- [ ] 10.2 Add privacy checks to tagging
...
- [ ] 10.3 Add privacy checks to mentions
...
- [ ] 10.4 Add privacy checks to messaging
...
- [ ] 10.5 Filter blocked and muted content
...
- [ ] 10.6 Implement search visibility controls
